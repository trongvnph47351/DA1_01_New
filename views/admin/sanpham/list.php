    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $pr['gia'] ?>VND</td>
                <td><img src="../upload/<?= $pr['img'] ?>" alt="" width="50px"></td>
                <td><?= $pr['ten_danh_muc'] ?></td>
                <td><a href="?act=updateproduct&id=<?= $pr['id'] ?>"><button class="btn btn-warning">Sửa</button></a>
                </td>
                <td><a onclick="return confirm('Bạn có muốn xóa không ?')"
                        href="?act=deleteproduct&id=<?= $pr['id'] ?>"><button class="btn btn-danger">Xóa</button></a>
                </td>
            </tr>
            <?php }
                ?>
