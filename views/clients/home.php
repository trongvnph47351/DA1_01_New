        ...
        <div class="slider-banner">
            <div class="single-banner banner-1">
                <a class="banner-thumb" href="#"><img
                        src="https://up.yimg.com/ib/th?id=OIP.QFnyWqFsGrQrEFl5LBHa-QHaHa&pid=Api&rs=1&c=1&qlt=95&w=107&h=107"
                        alt="" /></a>
            ...
            <div class="single-banner banner-2">
                <a class="banner-thumb" href="#"><img
                        src="https://up.yimg.com/ib/th?id=OIP.o3sUPR1Uq3DtGUhcYXP2rQHaHa&pid=Api&rs=1&c=1&qlt=95&w=107&h=107"
                        alt="" /></a>
                <div class="banner-brief">
        ...
        <div class="slider-area">
            <div class="bend niceties preview-2">
                <div id="ensign-nivoslider" class="slides">
                    <img src="./upload/banner1.jpg" alt="" title="#slider-direction-1" />
                    <img src="./upload/banner2.jpg" alt="" title="#slider-direction-2" />
                    <img src="./upload/banner3.jpg" alt="" title="#slider-direction-3" />
                </div>
                <!-- direction 1 -->
                ...
                ?> <ul>
                    ...
                    <li><a href="#" title="Login"><i class="zmdi zmdi-lock"></i></a>
                        <div class="customer-login text-left">
                            <form action="#">
                                <span>Tên đăng nhâp: <?=$ten_dang_nhap?></span>
                    <li>
                        <a href="">Gior hàng</a>
                    </li>
                    <li>
                    ...
                    <div class="col-12">
                        <div class="single-product">
                            ...
                            <div class="product-info clearfix text-center">
                                <div class="fix">
                                    <h4 class="post-title"><a href="?act=detailproduct"><?= $sp['ten_san_pham'] ?></a>
                                    </h4>
                                </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="new-arrivals">
                        <div class="row">
                            ...
                            <div class="single-product col-xl-3 col-lg-4 col-md-6">
                                <div class="product-img">
                                    <span class="pro-label new-label">new</span>
                                    <a href="single-product.html"><img src="./upload/9.jpg" alt="" /></a>
                                    <div class="product-action clearfix">
                                ...
                                <div class="product-info clearfix">
                                    ...
                                    <div class="fix">
                                        ...
                                        <span class="pro-rating floatright"> <a href="#"><i
                    ...
                    <div class="tab-pane" id="best-seller">
                        <div class="row">
                            ...
                            <!-- Single-product start -->
                            <div class="single-product col-xl-3 col-lg-4 col-md-6">
                                <div class="product-img"> <a href="single-product.html"><img src="img/product/8.jpg"
                                            alt="" /></a>
                                    <div class="product-action clearfix">
                                        <a href="wishlist.html" data-bs-toggle="tooltip" data-placement="top"
                                            title="Wishlist"><i class="zmdi zmdi-favorite-outline"></i></a>
                            ...
                            <div class="single-product col-xl-3 col-lg-4 col-md-6">
                                <div class="product-img">
                                    <a href="single-product.html"><img src="img/product/6.jpg" alt="" /></a>
                                    <div class="product-action clearfix"> <a href="wishlist.html"
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-action clearfix">
                                        <a href="wishlist.html" data-bs-toggle="tooltip" data-placement="top"
                                            title="Wishlist"><i class="zmdi zmdi-favorite-outline"></i></a>
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#productModal"
                                            title="Quick View"><i class="zmdi zmdi-zoom-in"></i></a> <a href="#"
                                            data-bs-toggle="tooltip" data-placement="top" title="Compare"><i
                                                class="zmdi zmdi-refresh"></i></a>
                                        <a href="cart.html" data-bs-toggle="tooltip" data-placement="top"
                                            title="Add To Cart"><i class="zmdi zmdi-shopping-cart-plus"></i></a>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-action clearfix">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#productModal"
                                            title="Quick View"><i class="zmdi zmdi-zoom-in"></i></a>
                                        <a href="#" data-bs-toggle="tooltip" data-placement="top" title="Compare"><i
                                                class="zmdi zmdi-refresh"></i></a> <a href="cart.html"
                        ...
                        <div class="row">
                            ...
                            <div class="single-product col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="product-info clearfix">
                                    ...
                                    <div class="fix"> <span class="pro-price floatleft">$ 57.20</span>
                                        <span class="pro-rating floatright">
                                            <a href="#"><i class="zmdi zmdi-star"></i></a>
                                            <a href="#"><i class="zmdi zmdi-star"></i></a>
                                            <a href="#"><i class="zmdi zmdi-star"></i></a>
...
<div class="subscribe-area pt-80">div class="container">
    <div class="row">
        <div class="col-lg-12">
            <div class="subscribe">
                <form action="#">
